    ...
    <body>        
        ...
        <div id="templatemo_wrapper">
                ...
                <div id="templatemo_menu" class="ddsmoothmenu">
                    <ul>
                        ...
                        <li><a href="about.html"><span></span>Play</a>
                            <ul>
                                <li><a href="selectbet.jsp">For Virtual Money</a></li>
            ...
            <div id="templatemo_middle">
                <div id="templatemo_middle_left">
                        <h2>Welcome to<strong>Se gana Gambling</strong></h2>
                    <p>The Web site where you will be able to play for real money, making your bets on your favorite sport and team.</p>
                ...
                <div id="templatemo_main">
                        ...
                        <div class="col_2 float_l">
                            ...
                            <div class="rp_pp">
                                <img class="image_frame" src="images/templatemo_image_03.png" alt="Image 03" />
                                <a href="#">Vestibulum quis nulla nunc, nec lobortis nunc.</a>
                                <p>Feb 16, 2048 - 165 comments</p>
                                <div class="cleaner"></div>
                            </div>
                            <div class="rp_pp">
                                <img class="image_frame" src="images/templatemo_image_04.png" alt="Image 04" />
                        ...
                        <div class="col_2 float_r">
                            ...
                            <div class="rp_pp">
                                <img class="image_frame" src="images/templatemo_image_06.png" alt="Image 06" />
                                <a href="#">Etiam Fringilla Sapien quis mauris  vestibulum.</a>
                                        <p>June 15, 2048 - 152 comments</p>
                                <div class="cleaner"></div>
                            </div>
                            <div class="rp_pp">
                                <img class="image_frame" src="images/templatemo_image_07.png" alt="Image 07" />
        ...
        <div id="templatemo_footer_wrapper">
                ...
                <div class="col_4 col_l">
                    ...
                    <a href="http://www.iwebsitetemplate.com" target="_parent">Website Templates</a> by <br />
